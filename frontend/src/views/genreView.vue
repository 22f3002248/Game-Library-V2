      ...
      >
        ...
        <div class="flex space-x-2">
          ...
          <div>
            <button
              ...
              @click="
                ;(showFilterForm = true), (showData = false), (showBtn = true)
              "
            >
              Filter
            </button>
        ...
        <div v-if="showFilterForm" class="flex justify-start">
          <form @submit="onFilter">
            ...
            <div>
              <button type="submit" class="btn btn-sm btn-accent ml-3 mt-3">
                OK
              </button>
            </div>
          </form>
        ...
        <div v-if="showFilterData">
          <div v-if="greenFlag" class="mt-5 text-center text-bold text-error">
            Games not found
          </div>
          <div v-else>
            <table class="table w-full">
